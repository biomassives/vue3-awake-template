...
<head>
    ...
    <title>Eco Ops Program Enhanced Flow</title>
...
<body>
    <div class="mermaid">
        flowchart TD
            ...
            R[Climate Change Mitigation Projects] --> S[Renewable Energy Initiatives]
            S --> T[Climate-Resilient Agriculture]
            U[Healthcare Infrastructure Improvement] --> V[Access to Clean Water and Sanitation]
            V --> W[Reduced Health Risks]
            X[Policy and Advocacy] --> Y[Policies to Reduce Emissions]
            Y --> Z[Social Equity and Sustainable Development]

            classDef default fill:#f9f,stroke:#333,stroke-width:2px;
            class L,S,T,U,V,W,X,Y,Z default;
    </div>
</body>
</html>
